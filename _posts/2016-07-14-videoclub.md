---
layout: post
title: 30 Programa 01
date:  2016-07-14 00:00:00
---

Exemple de programa on es veuen clarament les **classes** per tal de poder analitzar-ne l'estructura de les mateixes:
...
class Videoclub:
    ...
    def alquilar_pelicula(self, titulo, dni):
        ...
        # si lo consigue. La fecha de alquiler se fija automáticament al dia
        # actual.
    ...
    def devolver_pelicula(self, titulo, dni):
        ...
        # de retrase, o -1 si ningun ejemplar de la plicula está alquilado
        # al socio.
        # Requisito: debe existir un socio con el DNI suministrado.
        for pelicula in self.peliculas:
...
def nueva_pelicula():
    # Pide por teclado los datos de una nueva peĺicula y devuelve un
    ...
    if opcion == 0:
        ...
        if hay_pelicula and hay_socio:
            ...
            if resultado == 0:
                ...
                print('La pelicula', titulo, 'no está alquilada al socio', dni)
        else:
            if not hay_pelicula:
                print('No hay pelicula titulada', titulo)
            if not hay_socio:
